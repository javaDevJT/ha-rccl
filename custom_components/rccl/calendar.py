...
def _async_setup_club_royale_calendars(
    ...
    _remove_legacy_club_royale_offer_calendars(hass, entry)
...
def _remove_legacy_club_royale_offer_calendars(
    hass: HomeAssistant,
    entry: ConfigEntry,
) -> None:
    """Remove legacy per-offer calendars that duplicated offer date sensors."""
